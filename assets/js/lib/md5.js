// Minimalistní MD5 (veřejná doména, dle RFC 1321). Vrací hex řetězec.
// Používá se v hash-gen; SHA-256/512 se počítají nativně přes SubtleCrypto.
(function () {
  ...
  function binl2hex(binarray) {
    ...
    for (var i = 0; i < binarray.length * 4; i++) {
      out += hex.charAt((binarray[i >> 2] >> ((i % 4) * 8 + 4) & 0x0f)) + hex.charAt((binarray[i >> 2] >> ((i % 4) * 8) & 0x0f));
    }
    return out;
  }
